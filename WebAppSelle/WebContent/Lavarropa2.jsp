...
<div class="bs-example" >
    <h1>Nuevo Lavarropa</h1>
    
    <form id="validarLavarropa" data-toggle="validator" role="form" class="form-horizontal" action="agregarLavarropa" method="post">
        ...
        <div class="form-group">
            <label class="control-label col-xs-3" for="carga">Carga:</label>
            <div class="col-xs-2">
                <input type="text" name="carga" pattern="^([_0-9]){1,}$" class="form-control" id="carga" placeholder="Carga" data-error="Completar este campo" required>
            </div>
         </div>
